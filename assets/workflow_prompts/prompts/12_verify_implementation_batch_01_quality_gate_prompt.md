# Prompt 12 — Quality gate after implementation batch 1
...
REPORT_FILE = assets/<VENDOR>/<MODEL>/workflow_reports/12_verify_each_implementation_batch_quality_gate_report.md
